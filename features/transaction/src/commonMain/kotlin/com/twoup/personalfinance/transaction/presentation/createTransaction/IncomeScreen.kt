...
//    isExpenseScreen: Boolean // Add this parameter
//) {
...
//    )
//
//    val amountText = if (isExpenseScreen) {
//        createTransUiState.value.expenses.toString()
//    } else {
//        createTransUiState.value.income.toString()
//    }
//
//    LineTransInfor(
//        text = amountText,
...
//                    income = if (isExpenseScreen) 0 else createTransUiState.value.income,
//                    expenses = if (isExpenseScreen) createTransUiState.value.expenses else 0,
//                    transferBalance = 0,
...
//                    if (isExpenseScreen) MR.colors.createTrans_tab_expense else MR.colors.createTrans_tab_income
//                )
//            ),
...
//            )
//        }
//        // Create this transaction and continue creating another transaction
//        Button(
